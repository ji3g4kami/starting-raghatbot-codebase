...
class TestCourseSearchTool:
    ...
    def test_execute_successful_query(
        self, course_search_tool_with_mock, mock_search_results_success
    ):
    ...
    def test_execute_empty_results(
        self, course_search_tool_with_mock, mock_search_results_empty
    ):
    ...
    def test_execute_empty_results_with_both_filters(
        ...
        # Execute
        result = tool.execute(
            query="test query", course_name="Test Course", lesson_number=5
        )
    ...
    def test_execute_with_vector_store_error(
        self, course_search_tool_with_mock, mock_search_results_error
    ):
    ...
    def test_execute_with_course_name_parameter(
        self, course_search_tool_with_mock, mock_search_results_success
    ):
    ...
    def test_execute_with_lesson_number_parameter(
        self, course_search_tool_with_mock, mock_search_results_success
    ):
    ...
    def test_execute_with_both_parameters(
        self, course_search_tool_with_mock, mock_search_results_success
    ):
    ...
    def test_format_results_with_lesson_links(
        ...
        # Setup
        tool = course_search_tool_with_mock
        tool.store.get_lesson_link.side_effect = (
            lambda course, lesson: f"https://example.com/lesson{lesson}"
        )

        # Execute format_results directly
        tool._format_results(mock_search_results_success)
        ...
        tool.store.get_lesson_link.assert_any_call(
            "Test Course: Introduction to Testing", 1
        )
        tool.store.get_lesson_link.assert_any_call(
            "Test Course: Introduction to Testing", 2
        )
    ...
    def test_source_tracking_reset_between_calls(
        self, course_search_tool_with_mock, mock_search_results_success
    ):
    ...
    def test_execute_with_various_query_inputs(
        self,
        course_search_tool_with_mock,
