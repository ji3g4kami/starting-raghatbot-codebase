...
class TestVectorStore:
    ...
    def test_search_with_both_filters(
        ...
        results = temp_vector_store.search(
            "concepts", course_name="Test Course", lesson_number=1
        )
    ...
    def test_search_nonexistent_course(
        ...
        results = temp_vector_store.search(
            "testing", course_name="Cooking Recipes Food Kitchen"
        )
    ...
    def test_resolve_course_name_exact_match(self, temp_vector_store, sample_course):
        ...
        # Execute
        resolved = temp_vector_store._resolve_course_name(
    ...
    def test_get_existing_course_titles_with_data(
        self, temp_vector_store, sample_course
    ):
    ...
    def test_search_exception_handling(self, temp_vector_store):
        ...
        with patch.object(
            temp_vector_store.course_content,
            "query",
